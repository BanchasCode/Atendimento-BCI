...
<div class="head">
    ...
    <div class="welcome">
        <label>Bem-vindo(a), <?php echo $_SESSION['staff_name']; ?></label>
        <h6 class="lstlogin">Último acesso: <?php echo $row['Last_login']; ?></h6>
    </div>

    <a class="staff_home" href="staff_profile.php">
        <input type="button" name="home" value="Início">
    </a>

    <a class="staff_logout" href="staff_logout.php">
        <input type="button" name="logout_btn" value="Sair">
    </a>
</div>
